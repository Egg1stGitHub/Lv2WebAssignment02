...
-- --------------------------------------------------------
CREATE DATABASE `webassignment2`;
GRANT USAGEON *.* TO 'group4'@'localhost' IDENTIFIED BY '123456';
GRANT ALL PRIVILEGES ON `webassignment2`.* TO 'group4'@'localhost';
FLUSH PRIVILEGES;s
USE `webassignment2`;
...
--
ALTER TABLE `child_t`
  MODIFY `child_id` int(11) AUTO_INCREMENT, AUTO_INCREMENT=8;
