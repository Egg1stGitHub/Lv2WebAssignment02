...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "DELETE FROM child_t WHERE child_id ='$id'";
...
<div id="content">
  ...
  <div class="page delete">
    ...
    <p class="item"><?php echo $result['child_id'] . $result['m_healthcard'] . $result['c_firstname'] . $result['c_lastname']; ?></p>

    <form  action="<?php echo 'delete_child.php?id=' . $result['child_id']; ?>"  method="post">
      <div id="operations">
