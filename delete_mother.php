...
<title>delete mother infor page</title>
</head>
<body>
<?php
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "DELETE FROM mother_t WHERE momhealthcard ='$id'";
...
<div id="content">
  ...
  <div class="page delete">
    ...
    <p class="item"><?php echo $result['momfullname'] . $result['momhealthcard']; ?></p>

    <form action="<?php echo 'delete_mother.php?id=' . $result['momhealthcard']; ?>"  method="post">
      <div id="operations">
